...
struct UDConfettiViewModifier: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            .confettiCannon(counter: $counter,
                            ...
                            yOffset: -(UIScreen.main.bounds.height / 2) - 188)
            .onAppear {
                counter += 1
            }
    }
...
public extension View {
    ...
    func udConfetti(counter: Binding<Int>) -> some View {
        modifier(UDConfettiViewModifier(counter: counter))
    }
    
    @ViewBuilder
    func confettiCannon(counter: Binding<Int>,
                        num: Int = 20,
