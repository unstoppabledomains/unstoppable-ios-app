...
private extension FirebasePurchaseDomainsService {
    ...
    func aiSearchForFBDomains(hint: String) async throws -> [FirebasePurchase.DomainProductItem] {
    ...
    func getENSDomainStatus(domainName: String) async throws -> FirebasePurchase.ENSDomainProductStatusResponse {
        let urlString = URLSList.DOMAIN_ENS_STATUS_URL(domain: domainName)
        let request = try APIRequest(urlString: urlString,
                                     method: .get)
        let status: FirebasePurchase.ENSDomainProductStatusResponse = try await makeFirebaseDecodableAPIDataRequest(request,
...
private extension FirebasePurchaseDomainsService {
    ...
    func createCartFromUDCart(_ udCart: FirebasePurchase.UDUserCart) -> PurchaseDomainsCart {
...
private extension DomainToPurchase {
    init(domainProduct: FirebasePurchase.DomainProductItem) {
