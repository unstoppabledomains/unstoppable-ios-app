...
class UDRouter: DomainProfileSignatureValidator {
    ...
    func showChatsListScreen(in nav: CNavigationController) {
        let vc = buildChatsListModule()
        
        nav.pushViewController(vc, animated: true)
    }
    
    func showChatScreen(channelType: ChatChannelType,
                        in nav: CNavigationController) {
        let vc = buildChatModule(channelType: channelType)
...
private extension UDRouter {
    ...
    func buildChatsListModule() -> UIViewController {
    ...
    func buildChatModule(channelType: ChatChannelType) -> UIViewController {
