...
final class ConfirmWordsViewController: BaseViewController {
    ...
    @IBOutlet private weak var forgotWordsButton: UIButton!
...
private extension ConfirmWordsViewController {
    ...
    func localiseContent() {
        ...
        forgotWordsButton.setAttributedTextWith(text: String.Constants.iForgotMyWords.localized(),
    ...
    func createConfirmationWordsLayout() -> UICollectionViewLayout {
        ...
        let layout = UICollectionViewCompositionalLayout(sectionProvider: {
            ...
            let widthDimension: NSCollectionLayoutDimension = isLastSection ? .absolute(layoutEnvironment.container.contentSize.width - (spacing * 2)) : .fractionalWidth(0.85)
