...
final class DomainsCollectionListCell: BaseListCollectionViewCell {
    ...
    @IBOutlet private weak var profileIndicatorImageView: UIImageView!
    ...
    override func awakeFromNib() {
        ...
        profileIndicatorImageView.tintColor = .foregroundMuted
...
extension DomainsCollectionListCell {
    func setWith(domainItem: DomainItem, isUpdatingRecords: Bool, isSelectable: Bool, isReverseResolution: Bool) {
        ...
        profileIndicatorImageView.isHidden = !(domainItem.isPrimary == true)
        ...
        case .normal:
            ...
            statusMessage.isHidden = !isUpdatingRecords
        }
        reverseResolutionIndicatorImageView.isHidden = !isReverseResolution
    }
}
